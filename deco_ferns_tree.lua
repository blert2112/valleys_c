...
minetest.register_node("valleys_c:tree_fern_leaves_giant", {
		...
		items = {
			{
				...
				--  reharvesting leaves)
				items = {"valleys_c:sapling_giant_tree_fern"},
				rarity = 10,
			},
			{
				items = {"valleys_c:sapling_giant_tree_fern"},
			...
			{
				items = {"valleys_c:tree_fern_leaves_giant"},
			}
		}
	},
...
-----------------------------------------------------------------------------------------------
minetest.register_node("valleys_c:tree_fern_leaf_big", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("valleys_c:tree_fern_leaf_big_end", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("valleys_c:fern_trunk_big_top", {
...
-----------------------------------------------------------------------------------------------
minetest.register_node("valleys_c:fern_trunk_big", {
	description = "Giant Fern Trunk",
	drawtype = "nodebox",
	paramtype = "light",
	tiles = {
	...
	after_destruct = function(pos,oldnode)
        ...
        if node.name == "valleys_c:fern_trunk_big" or node.name == "valleys_c:fern_trunk_big_top" then 
            minetest.dig_node({x=pos.x,y=pos.y+1,z=pos.z}) 
            minetest.add_item(pos,"valleys_c:fern_trunk_big")
        end
    end,
})
...
-----------------------------------------------------------------------------------------------
minetest.register_node("valleys_c:sapling_giant_tree_fern", {
...
minetest.register_abm({
	nodenames = "valleys_c:sapling_giant_tree_fern",
	interval = 1000,
	chance = 4,
