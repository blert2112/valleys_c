...
minetest.register_node("valleys_c:red_clay", {
	...
	minetest.register_abm({
		...
		action = function(pos, node)
			...
			if nodedef and (nodedef.sunlight_propagates or nodedef.paramtype == "light")
				...
				if name == "default:snow" or name == "default:snowblock" or (valc.test_snow and valc.test_snow({x=pos.x, y=pos.y+1, z=pos.z})) then
					minetest.set_node(pos, {name = itemstr_snow})
				elseif valc.test_dry and valc.test_dry(pos) then
